...
const Social = () => {
  ...
  return (
    <div className="w-11/13 mx-auto my-10 flex flex-col xsm:flex-row xsm:justify-between">
      ...
      <button
        onClick={() => scrollToTop()}
        className="bg-[#D9D9D9] hover:bg-white hover:drop-shadow-lg text-grey-darkest font-semibold text-center py-3 px-4 rounded inline-flex justify-center items-center w-full xsm:w-fit xsm:py-0"
      >
